...
final class Version20181115175021 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE SEQUENCE theater_info_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE session (id INT NOT NULL, movie_id INT NOT NULL, theater_id INT NOT NULL, type VARCHAR(255) NOT NULL, type_screen VARCHAR(255) NOT NULL, room VARCHAR(255) NOT NULL, type_room VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, date_hour TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_D044D5D48F93B6FC ON session (movie_id)');
        $this->addSql('CREATE INDEX IDX_D044D5D4D70E4479 ON session (theater_id)');
        ...
        $this->addSql('CREATE TABLE theater_info (id INT NOT NULL, theater_id INT NOT NULL, city_id INT NOT NULL, address_id INT NOT NULL, name VARCHAR(255) NOT NULL, is_active BOOLEAN NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE session ADD CONSTRAINT FK_D044D5D4D70E4479 FOREIGN KEY (theater_id) REFERENCES theater (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE theater_info ADD CONSTRAINT FK_2DA8B7F9D70E4479 FOREIGN KEY (theater_id) REFERENCES theater (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE theater_info ADD CONSTRAINT FK_2DA8B7F98BAC62AF FOREIGN KEY (city_id) REFERENCES city (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE theater_info ADD CONSTRAINT FK_2DA8B7F9F5B7AF75 FOREIGN KEY (address_id) REFERENCES address (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE session DROP CONSTRAINT FK_D044D5D4D70E4479');
